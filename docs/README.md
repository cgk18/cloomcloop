...
- [research/loop-to-graph.md](research/loop-to-graph.md) — the "loop → graph engineering" debate, primary sources, and the design constraints we adopted.

Illustrated report (same material, shareable): https://claude.ai/code/artifact/9f270399-1db6-4caf-a227-5be4a76728ca
